            ...
            <div class="logo">
               <center><img src="<?php echo base_url()?>assets/img/logoo.png" height=70 ></center>
                <a href="" class="simple-text">
                    <font><b>PPDB SMAN 4 MOJOKERTO</b></font>
                </a>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo site_url()?>/buku/index">
                                <i class="ti-plus"></i>
                                <p><font color='black'> &nbsp Tambah Data</font></p>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url()?>/buku/tampil_buku">
...
<td align="right" width="10%"> Agama*</td>
                    <td width="2%"></td>
                    <td width="35%">
                    <input type="text" class="form-control" id="agama" name="agama" placeholder="Agama" aria-describedby="basic-addon3">
...
<td align="right" width="10%"> Kabupaten/Kota*</td>
                 ...
                 <td align="right" width="10%"> Tanggal Lahir*</td>
                    <td width="2%"></td>
                    <td width="35%">
                      <input type="date" format="dd/mm/yyyy" placeholder="Masukkan Tanggal Lahir" class="form-control" id="tanggal_lahir" name="tanggallahir" aria-describedby="basic-addon3">
                 ...
                 <td align="right" width="10%"> Jenis Kelamin*</td>
                    <td width="2%"></td>
                    <td width="35%">
                    <input checked="" value="laki-laki" type="radio" id="tempat_lahir" name="jenis_kelamin" placeholder="Masukkan TTL" aria-describedby="basic-addon3">laki-laki
                    <input type="radio" value="perempuan" id="tempat_lahir" name="jenis_kelamin" placeholder="Masukkan TTL" aria-describedby="basic-addon3">perempuan
...
<tr> <td align="right" width="10%">Data Wali</td></tr>               
 ...
 <tr>
                <td align="right" width="10%"> No Handdphone Wali</td>
                    <td width="2%"></td>
                    <td width="35%">
...
<tr>
                ...
                <td align="right" width="10%"> Pilihan 1</td>
                    <td width="2%"></td>
                    <td width="35%">
                  <input type="text" class="form-control" id="pilihan1" name="pilihan1" placeholder="Masukkan PILIHAN 1" aria-describedby="basic-addon3">
                ...
                <td align="right" width="10%"> Pilihan 2</td>
                    ...
                    <td width="35%">
                  <span>
                   <input type="text" class="form-control" id="pilihan2" name="pilihan2" placeholder="Masukkan PILIHAN 2" aria-describedby="basic-addon3"></span>
