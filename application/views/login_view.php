...
<div class="container">
            ...
            <br><br> 
                            <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                                ...
                                <tbody>
                                <?php foreach ($login_list as $key) { ?>
                                    <tr>
                                     <td align="center">
                                            <a href="<?php echo site_url('data_login/update/').$key->id ?>" type="button" class="btn btn-info"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                            <a type="button" class="btn btn-danger " href="<?php echo site_url('data_login/delete/').$key->id ?>" onClick="return confirm('Apakah Anda Yakin?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </button>
                                        </td>
