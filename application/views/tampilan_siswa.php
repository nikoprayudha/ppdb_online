      ...
      <header class="main-header">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <img class="img-rounded" src="<?php echo base_url()?>assets/uploads/<?php echo $foto; ?>">
 
           
            </div>
            <font color="white"><?php echo $username; ?></font>
          </div>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <center>
                  <span class="info-box-text"><H4><b><big>SELAMAT DATANG</big></b></H4></span>
                  <span class="info-box-text"><b><big>DI PORTAL PENERIMAAN PESERTA DIDIK BARU (PPDB) ONLINE</big></b></span>
                  
                  <span class="info-box-text"><b><big>TAHUN 2017/2018</big></b></span>
                  </center>
