...
<div class="container">
     ...
     <?php $attributes = array("nama_pilihan" => "pilihan");
      echo form_open_multipart('data_jurusan/update/'.$this->uri->segment(3)); ?>

    <table width=1000 border='0' height=250 align="center"> 
  
                <tr>
                    <td align="right" width="10%">Jurusan*</td>
                    <td width="2%"></td>
                    <td width="35%">
                     <input type="text" class="form-control" id="nama_pilihan" name="nama_pilihan" placeholder="Masukkan Kategori jurusan" aria-describedby="basic-addon3" value="<?php echo $jenis[0]->nama_pilihan ?>">
