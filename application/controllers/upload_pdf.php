          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('data_asal')?>"<i class="fa fa-edit"></i>  Data Asal Sekolah</a></li>
                <li><a href="<?php echo site_url('data_orang')?>"<i class="fa fa-edit"></i> </i> Data Orang Tua/Wali</a></li>
                <li><a href="<?php echo site_url('data_nilai')?>"<i class="fa fa-edit"></i> </i> Data Nilai</a></li>
              </ul>
            </li>
